...
def on_message(client, userdata, msg):
    print("Got message: "+ msg.topic+" --> "+ msg.payload.decode())
    if msg.topic == "topic/door":
        if msg.payload.decode() == '{success:error}':
            print("ALARM!!!")
    elif msg.topic == "topic/pressure":
        if int(msg.payload.decode()) != OK_PRESSURE:
            print("ALARM!!!")
